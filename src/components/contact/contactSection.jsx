...
return (
    <section className="bg-[#fdf8e9] py-10">
      <div className="max-w-6xl sm:mx-auto grid md:grid-cols-2 rounded-xl overflow-hidden px-2 mr-2 sm:px-1">
          ...
          <div>
            <div className='flex items-start gap-4 font-[600]' data-aos="fade-up" data-aos-delay="700">
              ...
              <div className="flex flex-col mb-10">
                <p className='text-[14px]'>Visit Our Branches</p>
...
Colombo 06 <br /> </p>
            ...
            <div className='flex items-start gap-4 font-[600]' data-aos="fade-up" data-aos-delay="800">
              ...
              <div className="flex flex-col mb-10">
                ...
                <p className='text-[14px]'>+94 11 236 1136 / +94 74 261 0334</p>
